"""Retrieve information about a Mist network from the Mist API.
...
def get_devices(headers, mist_url, site_id):
    ...
    response = requests.get(device_url, headers=headers, timeout=REQUEST_TIMEOUT_SECONDS)
...
def get_device_stats(headers, mist_url, site_id):
    ...
    response = requests.get(device_stats_url, headers=headers, timeout=REQUEST_TIMEOUT_SECONDS)
    if response.status_code != 200:
...
def get_wlans(headers, mist_url, site_id):
    ...
    response = requests.get(wlan_url, headers=headers, timeout=REQUEST_TIMEOUT_SECONDS)
    if response.status_code != 200:
...
def get_beacons(headers, mist_url, site_id):
    ...
    response = requests.get(beacons_url, headers=headers, timeout=REQUEST_TIMEOUT_SECONDS)
    if response.status_code != 200:
...
def get_aps(headers, mist_url, site_id):
    ...
    response = requests.get(ap_url, headers=headers, timeout=REQUEST_TIMEOUT_SECONDS)
    if response.status_code != 200:
...
def get_rf_stats(headers, mist_url, site_id):
    ...
    response = requests.get(rf_stats_url, headers=headers, timeout=REQUEST_TIMEOUT_SECONDS)
    if response.status_code != 200:
        raise Exception(
...
def get_clients(headers, mist_url, site_id):
    ...
    response = requests.get(client_url, headers=headers, timeout=REQUEST_TIMEOUT_SECONDS)
    if response.status_code != 200:
        raise Exception(
